...
Requires:   python2-%{pypi_name} = %{upstream_version}-%{release}
...
Requires:       python3-tenacity >= 3.1.1
Requires:       python3-six >= 1.9.0
Requires:       python3-neutron-lib >= 0.4.0
...
Summary:    A common library that interfaces with VMware NSX - tests
Requires:   python3-%{pypi_name} = %{upstream_version}-%{release}
